...
from utils.graph_ops import (
    ...
    endpoint_nodes,
    find_components,
    merge_close_nodes as _merge_close_nodes_impl,
...
class EndpointConnector:
    ...
    def _finalize(self, dense_c: np.ndarray, dense_e: np.ndarray,
        ...
        if merge_distance > 0 and len(simp_c) > 0:
            simp_c, simp_e, simp_nt, simp_ce, merge_map = _merge_close_nodes_impl(
                simp_c, simp_e, simp_nt, simp_ce, merge_distance)
